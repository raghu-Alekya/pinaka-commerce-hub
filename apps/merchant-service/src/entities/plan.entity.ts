...
export class PlanEntity {
  ...
  @Column({ name: 'store_type', type: 'varchar', length: 50, nullable: true })
  storeType!: string | null;
 
  @Column({ name: 'included_stores', type: 'integer', default: 0 })
  includedStores!: number;
 
  @Column({ name: 'included_terminals', type: 'integer', default: 0 })
  ...
  @Column({ name: 'included_employees', type: 'integer', default: 0 })
  ...
  @Column({ name: 'included_features', type: 'text', array: true, default: () => "'{}'::text[]" })
